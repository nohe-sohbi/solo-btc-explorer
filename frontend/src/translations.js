...
export const translations = {
    en: {
        ...
        walletValid: 'Valid mainnet address',
        walletInvalid: 'Invalid Bitcoin address',
        poolUrl: 'Pool URL',
        poolPort: 'Pool Port',
        ...
        oddsEvPerDay: 'Expected value / day',
        oddsEvPerYear: 'Expected value / year',
        oddsDays: 'days',
        oddsYears: 'years',
        oddsIn: 'in',
    ...
    fr: {
        ...
        walletValid: 'Adresse mainnet valide',
        walletInvalid: 'Adresse Bitcoin invalide',
        poolUrl: 'URL du Pool',
        ...
        oddsEvPerDay: 'Espérance de gain / jour',
        oddsEvPerYear: 'Espérance de gain / an',
        oddsDays: 'jours',
        oddsYears: 'ans',
        oddsIn: 'sur',
